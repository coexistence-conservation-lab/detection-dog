...
Requires estimation of expected true positive rate for the dog and the human. To date, Koda's sensitivity is around 80%. Harder to estimate for the human but lower than 50% (and in fact close to zero) is realistic. 
