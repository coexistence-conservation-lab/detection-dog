...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding=encoding, output_file=file.path(dirname(inputFile), 'results markdown format.html')) })
---
...
ggsave("figure for poster.png", height = 6, width = 6, units = "cm", dpi = 600)
...
ggsave("figure for publication.png", height = 10, width = 20, units = "cm", dpi = 300)
```
